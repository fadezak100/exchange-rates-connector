...
export declare abstract class AirbyteStreamBase {
     ...
     * inputs
     */
    abstract readRecords(syncMode: SyncMode, cursorField?: string[], streamSlice?: Dictionary<any>, streamState?: Dictionary<any>): AsyncGenerator<Dictionary<any>>;
    /**
     ...
     */
    streamSlices(syncMode: SyncMode, cursorField?: string[], streamState?: Dictionary<any>): AsyncGenerator<Dictionary<any> | undefined>;
    /**
