import { AirbyteConfig, AirbyteConnectionStatusMessage, AirbyteSpec } from './protocol';
export declare abstract class AirbyteConnector {
    /**
     ...
     */
    abstract check(config: AirbyteConfig): Promise<AirbyteConnectionStatusMessage>;
}
