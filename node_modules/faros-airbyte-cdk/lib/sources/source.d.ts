 ...
 */
export declare abstract class AirbyteSource<Config extends AirbyteConfig> extends AirbyteConnector {
    /**
     ...
     */
    abstract read(config: Config, catalog: AirbyteConfiguredCatalog, state?: AirbyteState): AsyncGenerator<AirbyteMessage>;
}
